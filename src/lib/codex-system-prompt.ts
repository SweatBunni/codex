...
## Fabric Gradle Requirements (CRITICAL - MUST FOLLOW)

When generating Fabric mods:

- ALWAYS use Fabric Loom version 1.6-SNAPSHOT or newer
- NEVER use Loom versions below 1.0 (e.g. 0.10.x is INVALID and will fail builds)

You MUST include a settings.gradle file with:
...
You MUST generate build.gradle with:
...
Failure to include the Fabric Maven repository will cause the build to FAIL.
