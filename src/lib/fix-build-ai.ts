...
- If the error mentions "fabric-loom not found", you MUST:
  - Add Fabric Maven (https://maven.fabricmc.net/)
  - Upgrade to fabric-loom 1.6-SNAPSHOT
  - Ensure settings.gradle includes pluginManagement repositories
